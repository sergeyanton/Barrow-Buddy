...
public class RegistrationForm {
    ...
    public static void validate(RegistrationForm registrationForm, BindingResult bindingResult) {
        ...
        } else if (checkOverMaxLength(registrationForm.getFirstName(), MAX_USER_NAME_LEN)) {
        ...
        if (!registrationForm.getNoSurnameCheckBox()) {
            ...
            } else if (checkOverMaxLength(registrationForm.getLastName(), MAX_USER_NAME_LEN)) {
        ...
        if (!checkBlank(registrationForm.getDob())) {
            if (checkDateNotInCorrectFormat(registrationForm.getDob())) {
                errors.add("dob", "Date is not in valid format, DD/MM/YYYY", registrationForm.getDob());
            ...
            } else if (checkDateBefore(registrationForm.getDob(), LocalDate.now().minusYears(121).plusDays(1))) {
