...
INSERT IGNORE INTO garden (id, name, address, suburb, city, postcode, country, size, owner_id) VALUES (1, 'The Hamilton Gardens', '21 Hungerford Crescent', 'Hamilton East', 'Hamilton', '3216', 'New Zealand', 540000, 1);
-- add some plants to the Hamilton Garden
INSERT IGNORE INTO plant (name, plant_count, description, planted_on_date, picture_path, garden_id) VALUES ('Rose Bush', 200, 'Fragrant, colorful garden flower.', null, '/images/defaultPlantPic.png', 1),
...
INSERT IGNORE INTO garden (id, name, address, suburb, city, postcode, country, size, owner_id) VALUES (2, 'The Christchurch Botanic Gardens', 'Rolleston Avenue', 'Christchurch Central', 'Christchurch', '8013', 'New Zealand', 210000, 1);
...
INSERT IGNORE INTO plant (name, description, picture_path, garden_id) VALUES ('Corpse Flower', 'The worlds smelliest flower.', '/images/defaultPlantPic.png', 2),
...
INSERT IGNORE INTO garden (id, name, address, suburb, city, postcode, country, owner_id) VALUES (3, 'The Jack Erskine Foyer Garden Set', 'University of Canterbury', 'Ilam', 'Christchurch', '8041', 'New Zealand', 1);
-- add some plants to the Jack Erskine Foyer Garden Set these are all house plants and there is at lease 3 of each kind
INSERT IGNORE INTO plant (name, plant_count, description, picture_path, garden_id) VALUES ('Spider Plant', 3, 'A hardy house plant with long, thin leaves.', '/images/defaultPlantPic.png', 3),
...
INSERT IGNORE INTO garden (id, name, address, suburb, city, postcode, country, size, owner_id) VALUES (4, 'User Test''s Secret Garden', '123 Fake Street', 'Fake Suburb', 'Fake City', '1234', 'Fake Country', 100, 2);
...
INSERT IGNORE INTO plant (name, plant_count, description, picture_path, garden_id) VALUES ('Cannabis', 420, 'A psychoactive drug plant.', '/images/defaultPlantPic.png', 4),
